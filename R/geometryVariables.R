...
#' @author Hanna Meyer
#' @seealso \code{\link{SDMTools}}, \code{\link{clump}}, \code{\link{borgIndices}}
#' @examples
#' 
...
geometryVariables <- function(x){
     ...
     borg<-borgIndices(Ar=cloudArea,Ur=perimeter,De=innerCircle*2,Du=outerCircle*2)
