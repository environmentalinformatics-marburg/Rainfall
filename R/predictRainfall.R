...
#' @param variables A string vector of variables which are included in the model. 
#' Variables which are actualy not needed by the model are ignored.
#' @param xderivTexture A string vector of variables from which Textures are included in the model. 
#' Variables which are actualy not needed by the model are ignored.
...
predictRainfall <- function (model, sunzenith, msg, variables, xderivTexture, rainmask,date){
  require(caret)
  library(raster)
