...
#' @param msg The 11 used channels of MSG. Use name conventions described 
#' in Details
#' @param variables A string vector of variables which are included in 
#' the model. 
#' Variables which are actualy not needed by the model are ignored.
#' @param xderivTexture A string vector of variables from which Textures are 
...
predictRainfall <- function (model, sunzenith, msg, variables, xderivTexture, 
                             rainmask,date){
  require(caret)
  library(raster)
